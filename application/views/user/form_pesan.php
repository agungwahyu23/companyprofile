    					...
    					<div class="card shadow-lg border-0 rounded-lg mt-15">
    						...
    						<div class="card-body">
    							<div class="col">
    								...
    								<form action="<?= base_url('Pesan/Post') ?>" method="post"
    									...
    									<div class="row">
    										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12"><label
    												class="small mb-1" for="nomor_telepon">Nomor Telepon</label>
    											<input type="text" class="form-control mb-3" id="nomor_telepon"
    												name="nomor_telepon" onkeypress="return event.charCode >= 48 && event.charCode <=57" placeholder="Nomor Telepon" required>
    										</div>
    										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12"><label
    												class="small mb-1" for="nomor_telepon">Alamat lengkap</label>
    											<input type="text" class="form-control mb-3" id="nomor_telepon"
    												name="alamat" placeholder="Alamat lengkap" required>
    										</div>
