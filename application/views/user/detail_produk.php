...
<!-- 
						<a href="<?= base_url('Pesan/index/wa/' . $produk['idProduk']) ?>" class="btn btn-pesan">Pesan Sekarang</a> -->

						<a href="<?= base_url('Pesan/index/wa/' . $produk['idProduk']) ?>" class="btn btn-pesan">Pesan lewat WA</a>

						<a href="<?= base_url('Pesan/index/email/' . $produk['idProduk']) ?>" class="btn btn-pesan-email">Pesan lewat email</a>
					</div>
